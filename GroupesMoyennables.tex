...
Notons tout d'abord $UC_b(\Gamma_d)$ l'ensemble des fonctions $f:\Gamma_s\to\C$ qui sont bornées et uniformément 
...
\end{align}
Où on a pu remplace $\lambda(g\inv)$ par $\lambda(g)$ en remplaçant $V$ par son symétrique. Cela permet de donner la caractérisation suivante de $UC_b(\Gamma_d)$.
...
\begin{proof}[Démonstration du théorème \ref{amenable_TFAE}] \TODO{}
\end{proof}
...
\subsection*{Sur la convergence uniforme des translatées}
