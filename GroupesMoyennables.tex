...
\begin{proof}[Démonstration du lemme \ref{dual_of_weak}]
    ...
    On a donc montré $\bigcap_{i\in I}\ker\psi_i\subseteq\ker\varphi$. Pour conclure, on va s'appuyer sur le lemme d'algèbre linéaire suivant :
    ...
    \begin{proof}[Démonstration du lemme \ref{span_dual_of_ker}]
        ...
        On a $\ker\widetilde{\Psi} = \ker\Psi = \bigcap_{i\in I}\ker\psi_i \subseteq \ker \varphi$, donc $\phi$ se factorise 
    ...
    Finalement, ce lemme fournit  $a : I\to\K$ telle que $\varphi = \sum_{i\in I} a_i\psi_i = \ket{\blank, \sum_{i\in I} a_i f_i}$,
