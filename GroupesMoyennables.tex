...
Cela implique tout d'abord que, si $f_1$ ou $f_2$ est presque nulle, $f_2\ast f_2$ l'est aussi, ce qui assure que 
$\ast$ passe au quotient en $\ast : \mathrm{L}^1 \times\mathrm{L}^1 \to \mathrm{L}^1$, et que l'opération 
bilinéaire obtenue est bien de norme inférieure à $1$, d'où finalement $\mathrm{L}^1(\Gamma, \mu)$ est bien une algèbre de Banach.
Enfin, si l'on munit $\mathrm{L}^1(\Gamma, \mu)$ de l'involution $f\mapsto\overline{f\comp\invop}$, qui est bien définie car 
les mesures de Haar $\invop_*\mu$ et $\mu$ sont absolument continues l'une par rapport à l'autre, on obtient une structure d'algèbre de Banach
involutive, puisque pour $f_1, f_2\in\mathscr{L}^1(\Gamma, \mu)$ et $x\in\Gamma$, on a :
\begin{align*}
    (f_1^*\ast f_2^*)(x) 
...
représentation, toujours notée $\pi$, de l'\emph{algèbre involutive} $\mathrm{L}^1(\Gamma, \mu)$. Soit donc $f\in\mathscr{L}^1(\Gamma, \mu)$.
